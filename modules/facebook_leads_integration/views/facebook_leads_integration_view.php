...
<div class="row">
	<div class="col-md-12">
		...
		<h4><?php echo htmlspecialchars(_l('app_settings')); ?></h4>
		<br>
		<?php echo render_input('appId', 'app_id',$query->appId); ?>
		<input type="hidden" value="<?php echo htmlspecialchars($query->appId) ?>" id="appId">
		<?php echo render_input('appSecret', 'app_secret', $query->appSecret); ?>
		<input type="hidden" value="<?php echo htmlspecialchars($query->appSecret) ?>" id="appSecret">
		<?php echo render_input('facebookPageId', 'Page Id', $query->facebookPageId); ?>
		<input type="hidden" value="<?php echo htmlspecialchars($query->facebookPageId) ?>" id="facebookPageId">
		<?php echo render_input('appAccessToken', 'Access Token', $query->appAccessToken); ?>
		<input type="hidden" value="<?php echo htmlspecialchars($query->appAccessToken) ?>" id="appSecret">
