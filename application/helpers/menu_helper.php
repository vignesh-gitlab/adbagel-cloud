...
function app_init_admin_sidebar_menu_items()
{
    ...
    if (has_permission('campaign', '', 'view') || has_permission('campaign', '', 'view_own')) {
        $CI->app_menu->add_sidebar_menu_item('campaign_manager', [
            'name'     => 'Campaign manager',
            'href'     => admin_url('leads/managecampaign'),
            'icon'     => 'fa fa-bullhorn',
            'position' => 45,
            'badge'    => []
        ]);
    ...
    if (is_staff_member()) {
        ...
        // $CI->app_menu->add_sidebar_menu_item('leads_manager', [
        //     'name'     => 'Leads Manager',
        //     'icon'     => 'fa fa-sitemap',
        //     'position' => 45,
        //     'badge'    => []
    ...
    if (has_permission('settings', '', 'view') || has_permission('settings', '', 'view_own')) {
