...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'adbagel'){
            copy(APPPATH . 'views/themes/adbagel/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
