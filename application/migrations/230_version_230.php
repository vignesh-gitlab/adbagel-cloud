...
class Migration_Version_230 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(VIEWPATH . 'themes/adbagel/scripts.php')) {
            @unlink(VIEWPATH . 'themes/adbagel/scripts.php');
        }
        ...
        foreach ($themes as $theme) {
            if ($theme != 'adbagel') {
                if (!file_exists(VIEWPATH . 'themes/' . $theme . '/functions.php')) {
                    copy(VIEWPATH . 'themes/adbagel/functions.php', VIEWPATH . 'themes/' . $theme . '/functions.php');
                }
            }
        }
