...
<script type="text/javascript">
 ...
 if (table_lead_manager.length) {
    ...
    //initDataTable('.table-lead-managerd', admin_url + 'lead_manager/table', undefined, undefined, 'undefined', [table_lead_manager.find('th.date-created').index(), 'desc']);
     lead_manager_table_api = initDataTable('.table-lead-managerd', admin_url + 'lead_manager/table', manageLeadsTableNotSearchable, manageLeadsTableNotSortable, LeadsManagerServerParams, [table_lead_manager.find('th.date-created').index(), 'desc']);
