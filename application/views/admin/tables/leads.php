...
foreach ($rResult as $aRow) {
    ...
    $row[] = ($aRow['phonenumber'] != '' ? ''.$aRow['phonenumber'].'<br><a href="tel:' . $aRow['phonenumber'] . '"><i class="fa fa-phone fa-2x" aria-hidden="true" style="font-size:23px;"></i></a><a href="https://web.whatsapp.com/send?phone=+'.$aRow['phonenumber'].'" target="_blank"><i class="fa fa-whatsapp fa-2x" aria-hidden="true" style="color:#fff;background:linear-gradient(#25d366,#25d366) 14% 84%/16% 16% no-repeat,radial-gradient(#25d366 60%,transparent 0);"></i></a>' : '');
    $row[] = '<p>'.$aRow['company'].'</p>';
