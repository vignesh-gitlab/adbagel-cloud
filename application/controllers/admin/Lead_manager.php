...
class Lead_manager extends AdminController
{
    ...
    public function index($id = '')
    {
        ...
        $data['leadid'] = $id;
        $this->load->view('admin/lead_manager/manage_leads', $data);
    }
    ...
    public function table()
    {
        ...
        $this->app->get_table_data('lead_manager');
    }
    ...
    public function activity_log()
    {
        ...
        if (!is_null($this->input->get('is_client'))) {
            ...
            $data['is_client'] = 1;
            $view = $this->load->view('admin/lead_manager/activity_log_client', $data, true);
        } else {
            $data['lead'] = $this->lead_manager_model->get($id, $leadWhere);
            $view = $this->load->view('admin/lead_manager/avtivity_log_modal', $data, true);
        }
        echo $view;
        exit();
    }
    public function send_sms_modal()
    {
        ...
        $view = $this->load->view('admin/lead_manager/send_sms_modal', $data, true);
        echo $view;
        exit();
    }
