module.exports = function(grunt) {
    ...
    let gruntConfig = {
        ...
        uglify: {
            my_target: {
                files: {
                    ...
                    'assets/themes/adbagel/js/clients.min.js': ['assets/themes/adbagel/js/clients.js'],
                    'assets/themes/adbagel/js/global.min.js': ['assets/themes/adbagel/js/global.js'],
        ...
        cssmin: {
            target: {
                files: [{
                        src: ['assets/themes/adbagel/css/style.css'],
                        dest: 'assets/themes/adbagel/css/style.min.css',
                        ext: '.min.css'
                    },
                    {
        ...
        postcss: {
            ...
            dist: {
                src: [
                    'assets/css/*.css',
                    '!assets/css/*.min.css',
                    'assets/themes/adbagel/css/*.css',
                    '!assets/themes/adbagel/css/*.min.css',
                ]
            }
        },
        concat: {
        ...
        header: {
            dist: {
                ...
                files: {
                    ...
                    'assets/themes/adbagel/js/clients.min.js': 'assets/themes/adbagel/js/clients.min.js',
                    'assets/themes/adbagel/js/global.min.js': 'assets/themes/adbagel/js/global.min.js',
                }
            }
        },
    }
